...
class HomeViewController: UIViewController {
    ...
    lazy var cashLabel: UILabel = {
        ...
        let digioAttributes: [NSAttributedString.Key: Any] = [
            ...
            .font: LayoutConstants.labelFont
        ]
    ...
    lazy var spotlightCarousel: UICollectionView = {
        ...
        layout.minimumLineSpacing = LayoutConstants.carouselItemSpacing
    ...
    lazy var productsCarousel: UICollectionView = {
        ...
        layout.scrollDirection = .horizontal
        layout.minimumLineSpacing = LayoutConstants.productCellSpacing
        carousel.backgroundColor = .clear
        carousel.showsHorizontalScrollIndicator = false
        carousel.isPagingEnabled = true
        return carousel
    ...
    private func setupWelcomeLabel() {
        ...
        NSLayoutConstraint.activate([
            welcomeLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor,
                                              constant: LayoutConstants.welcomeLabelTop),
            welcomeLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor,
                                                  constant: LayoutConstants.welcomeLabelLeading),
            welcomeLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor,
                                                   constant: LayoutConstants.welcomeLabelTrailing)
        ])
    }

    private func setupSpotlightCarousel() {
        view.addSubview(spotlightCarousel)
        spotlightCarousel.contentInset = UIEdgeInsets(top: LayoutConstants.carouselVerticalEdgeInsets,
                                                      left: LayoutConstants.carouselHorizontalInset,
                                                      bottom: LayoutConstants.carouselVerticalEdgeInsets,
                                                      right: LayoutConstants.carouselHorizontalInset)
        NSLayoutConstraint.activate([
            spotlightCarousel.topAnchor.constraint(equalTo: welcomeLabel.bottomAnchor,
                                                   constant: LayoutConstants.topSpacing),
            ...
            spotlightCarousel.heightAnchor.constraint(equalToConstant: LayoutConstants.carouselHeight)
        ])
    }

    private func addCashLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            cashLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor,
                                               constant: LayoutConstants.cashLabelLeading)
        ])
    }
    ...
    private func setupBannerImageView() {
        ...
        NSLayoutConstraint.activate([
            ...
            bannerImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor,
                                                     constant: LayoutConstants.bannerImageViewLeading),
            bannerImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor,
                                                      constant: LayoutConstants.bannerImageViewTrailing),
            bannerImageView.heightAnchor.constraint(equalToConstant: LayoutConstants.bannerImageViewHeight)
        ])
    ...
    private func setupProductsLabel() {
        ...
        NSLayoutConstraint.activate([
            productsLabel.topAnchor.constraint(equalTo: bannerImageView.bottomAnchor,
                                               constant: LayoutConstants.productsLabelSize),
            ...
            productsLabel.heightAnchor.constraint(equalToConstant: LayoutConstants.labelHeight)
        ])
    }

    private func setupProductsCarousel() {
        view.addSubview(productsCarousel)
        productsCarousel.contentInset = UIEdgeInsets(top: LayoutConstants.carouselVerticalEdgeInsets,
                                                     left: LayoutConstants.carouselHorizontalInset,
                                                     bottom: LayoutConstants.carouselVerticalEdgeInsets,
                                                     right: LayoutConstants.carouselHorizontalInset)
        NSLayoutConstraint.activate([
            ...
            productsCarousel.heightAnchor.constraint(equalToConstant: LayoutConstants.productsCarouselHeight)
        ])
    }
...
extension HomeViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView,
        ...
        if collectionView == spotlightCarousel {
            return LayoutConstants.spotlightCarouselItemSize(
                collectionViewWidth: collectionViewWidth)
        } else {
            return LayoutConstants.productsCarouselItemSize(
                collectionViewWidth: collectionViewWidth)
        }
    }
}
